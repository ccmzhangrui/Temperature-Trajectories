...
if __name__ == "__main__":
    ...
    # 修复列名引号错误
    trajectories = processed_data.groupby('patient_id')['temp_interpolated'] \
    ...
    gmm_analysis.to_csv("results_gmm.csv", index=False)
    ...
    pam_analysis.to_csv("results_pam.csv", index=False)
